...
func (o *GetServiceOK) Error() string {
	return fmt.Sprintf("[GET /services/{name}][%d] getServiceOK  %+v", 200, o.Payload)
}
...
func (o *GetServiceDefault) Error() string {
	return fmt.Sprintf("[GET /services/{name}][%d] getService default  %+v", o._statusCode, o.Payload)
}
